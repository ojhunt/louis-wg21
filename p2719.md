...
`template <template<typename> typename> void *operator new(T<int>, std::size_t)`.]{.draftnote audience=CWG}
...
the lack of any mechanism to otherwise force co-definition of new and delete operators]{.draftnote audience=CWG&EWG}
