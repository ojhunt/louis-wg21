...
- R6 (EWG and CWG Brno26):
  ...
  - Updated wording to address conflicts with the improved wording introduced
    by P3769
...
::: draftnote
Think about default arguments of deallocation functions and their dependence.
:::

::: draftnote
The wording around lookup and a call construction of deallocation functions in
new and delete means default arguments are not evaluated
:::
...
p30.2 is insufficient on its own for type-aware allocation and deallocation functions:
