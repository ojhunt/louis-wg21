...
- R6 (CWG Brno26):
  - No behavior or semantic changes
  - Updated wording to address conflicts with the improved wording introduced
    by P3769
  - Incorporate wording feedback from Vlad Serebrennikov
...
> [30.4]{.pnum} -- If multiple matching deallocation functions are found with
> type-identity parameters, all candidate functions other than the most viable
...
::: add
> [9]{.pnum} For an delete operator applied to an operand of type "pointer to `cv U`", the _type-identity argument_
...
Jabot, Richard Smith, Hana Dusikova, Vlad Serebrennikov, Lauri Vasama, and
others to help us develop the wording in this proposal.
